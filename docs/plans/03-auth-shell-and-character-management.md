...
- server-side admin security logic готова к подключению в будущий admin UI, но отдельный `super_admin` экран пока не входит в этап
...
- `super_admin` UI и admin navigation
