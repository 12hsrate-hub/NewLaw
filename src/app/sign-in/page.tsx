...
export default async function SignInPage({ searchParams }: SignInPageProps) {
  ...
  return (
    ...
    >
      ...
      <ContextPanel
        description="Войди в аккаунт, чтобы продолжить работу."
        eyebrow="NewLaw"
        title="Добро пожаловать"
      >
        <ul className="space-y-3 text-sm leading-6 text-[var(--muted)]">
          <li>Вход займёт всего пару секунд.</li>
          <li>Если доступ уже создан, используй свои данные для входа.</li>
          <li>Если что-то не получается, можно восстановить доступ со страницы входа.</li>
        </ul>
      </ContextPanel>
    </PageContainer>
  );
