...
describe("internal layout", () => {
  it("рендерит shared internal nav для overview, laws, precedents, security, access requests, ai legal core, ai review и health", () => {
    ...
    expect(html).toContain('href="/internal/ai-legal-core"');
    expect(html).toContain('href="/internal/ai-review"');
