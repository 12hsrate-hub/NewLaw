...
- OGP complaint MVP editor flow:
  ...
  - flat `evidenceItems[]` со ссылками уже сохраняются в persisted payload; старые группы/комментарии не являются OGP UI contract
