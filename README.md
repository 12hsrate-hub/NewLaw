...
- [src/app/account/characters](./src/app/account/characters) — owner-only grouped overview персонажей по серверам с default-character summary и temporary create bridge
