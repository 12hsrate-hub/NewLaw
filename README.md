...
- [src/app/account/trustors](./src/app/account/trustors) — owner-only grouped reusable trustor registry по серверам со встроенными create/edit/soft-delete entry points и без document integration
