...
- [src/app/servers/[serverSlug]/documents/claims/[documentId]](./src/app/servers/%5BserverSlug%5D/documents/claims/%5BdocumentId%5D) — owner-account claims editor MVP для `rehabilitation | lawsuit` без generation/publication слоя
